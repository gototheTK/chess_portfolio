// function WhiteKing(svg, player, initial = "d1") {
//     this.initialCoordinate = `translate(${toX(initial[0])},${toY(
//       initial[1]
//     )}) scale(${pieaceScale})`;
//     this.player = player;
//     this.svg = svg
...
//       )
//       .attr("transform", this.initialCoordinate);
//     this.svg
//       .append("path")
...
//     this.svg.on("click", () => {
//       this.player.select = this;
//       this.rect.attr("fill", possiblePlaceColor).attr("fill-opacity", 0.5);
//     });
//   }

//   function WhiteQueen(svg, player, initial = "e1") {
//     this.initialCoordinate = `translate(${toX(initial[0])},${toY(
//       initial[1]
//     )}) scale(${pieaceScale})`;
//     this.player = player;
...
//       .attr(
//         "style",
//         "opacity:1; fill:#ffffff; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1; cursor:pointer;"
//       )
//       .attr("transform", this.initialCoordinate);
//     this.svg
//       .append("path")
...
//   function WhiteBishop(svg, player, initial = "c1") {
//     this.player = player;
//     this.initialCoordinate = `translate(${toX(initial[0])},${toY(
//       initial[1]
//     )}) scale(${pieaceScale})`;
...
//     this.svg
//       .append("g")
//       .attr("style", "fill:#ffffff; stroke:#000000; stroke-linecap:butt;");

//     this.painting = this.svg
//       .append("g")
//       .attr(
//         "style",
//         "fill:#ffffff; stroke:#000000; stroke-linecap:butt; cursor:pointer;"
//       );
//     this.painting
//       .append("path")
//       .attr(
...
//   class WhiteKnight {
//     constructor(svg, board, coordinate = "b1") {
//       this.board = board;
//       this.coordinate = coordinate;
//       this.cell = board.cells[toRow[coordinate[1]] * 8 + toCol[coordinate[0]]];
//       this.cell.status = "white";
...
//       (row < ROWS.length || col < COLUMNS.length) &&
//         result.push(COLUMNS[col] + ROWS[row]);

//       row = toRow[coordinate[1]] + 1;
//       col = toCol[coordinate[0]] - 2;
//       (row < ROWS.length || col >= 0) && result.push(COLUMNS[col] + ROWS[row]);
...
//       row = toRow[coordinate[1]] - 1;
//       col = toCol[coordinate[0]] + 2;
//       (row >= 0 || col < COLUMNS.length) && result.push(COLUMNS[col] + ROWS[row]);
...
//   function WhiteRook(svg, player, initial = "a1") {
//     this.player = player;
//     this.initialCoordinate = `translate(${toX(initial[0])},${toY(
//       initial[1]
//     )}) scale(${pieaceScale})`;
...
//       )
//       .attr("style", "stroke-linecap:butt;");
//     this.svg.append("path").attr("d", "M 34,14 L 31,17 L 14,17 L 11,14");
//     this.svg
//       .append("path")
//       .attr("d", "M 31,17 L 31,29.5 L 14,29.5 L 14,17")
//       .attr("style", "stroke-linecap:butt; stroke-linejoin:miter;");
//     this.svg.append("path").attr("d", "M 31,29.5 L 32.5,32 L 12.5,32 L 14,29.5");
//     this.svg
//       .append("path")
...
//   class WhitePawn {
//     constructor(svg, board, coordinate = "a2") {
//       this.board = board;
//       this.coordinate = coordinate;
//       this.cell = board.cells[toRow[coordinate[1]] * 8 + toCol[coordinate[0]]];
//       this.cell.status = "white";
...
//         .attr(
//           "style",
//           "opacity:1; fill:#ffffff; fill-opacity:1; fill-rule:nonzero; stroke:#000000; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:miter; stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1; cursor:pointer;"
//         );
//       this.rect = this.svg
//         .append("rect")
//         .attr("width", 45)
...
//       const row = toRow[coordinate[1]] + 1;
...
// function BlackKing(svg, player, initial = "e8") {
//     this.player = player;
//     this.initialCoordinate = `translate(${toX(initial[0])},${toY(
//       initial[1]
//     )}) scale(${pieaceScale})`;
...
//   function BlackQueen(svg, player, initial = "d8") {
//     this.player = player;
//     this.initialCoordinate = `translate(${toX(initial[0])},${toY(
//       initial[1]
//     )}) scale(${pieaceScale})`;
...
//   function BlackBishop(svg, player, initial = "c8") {
//     this.player = player;
//     this.initialCoordinate = `translate(${toX(initial[0])},${toY(
//       initial[1]
//     )}) scale(${pieaceScale})`;
...
//     });
//   }
//   function BlackKnight(svg, player, initial = "b8") {
//     this.player = player;
//     this.initialCoordinate = `translate(${toX(initial[0])},${toY(
//       initial[1]
//     )}) scale(${pieaceScale})`;
...
//     this.svg
//       .append("path")
//       .attr("d", "M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18")
//       .attr("style", "fill:#000000; stroke:#000000;");
//     this.svg
//       .append("path")
//       .attr(
...
//     this.svg
//       .append("path")
//       .attr("d", "M 9.5 25.5 A 0.5 0.5 0 1 1 8.5,25.5 A 0.5 0.5 0 1 1 9.5 25.5 z")
//       .attr("style", "fill:#ffffff; stroke:#ffffff;");
//     this.svg
//       .append("path")
//       .attr("d", "M 15 15.5 A 0.5 1.5 0 1 1  14,15.5 A 0.5 1.5 0 1 1  15 15.5 z")
//       .attr("transform", "matrix(0.866,0.5,-0.5,0.866,9.693,-5.173)")
//       .attr("style", "fill:#ffffff; stroke:#ffffff;");
//     this.svg
//       .append("path")
...
//     });
//   }
//   function BlackRook(svg, player, initial = "a8") {
//     this.player = player;
//     this.initialCoordinate = `translate(${toX(initial[0])},${toY(
//       initial[1]
//     )}) scale(${pieaceScale})`;
...
//     });
//   }
//   function BlackPawn(svg, player, initial = "a7") {
//     this.player = player;
//     this.initialCoordinate = `translate(${toX(initial[0])},${toY(
//       initial[1]
//     )}) scale(${pieaceScale})`;
