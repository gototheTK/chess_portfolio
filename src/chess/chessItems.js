...
const board = (svg, player) => {
  return svg
    ...
    .on("click", (e, d) => {
      ...
      player.select && player.move();
    });
};

function WhiteKing(svg, player) {
  this.svg = svg
    .append("g")
    .attr("id", "whiteKing")
    .attr(
  ...
  this.svg.on("click", () => {
    this.player.select = this.svg;
  });
}

const whiteQueen = (svg) => {
  const p1 = svg
    .append("g")
    .attr(
      "style",
    ...
    .attr("transform", "translate(45,0) scale(" + pieaceScale + ")");
  p1.append("path")
...
const whiteBishop = (svg) => {
  const p2 = svg
    ...
    .attr("transform", "translate(90,0) scale(" + pieaceScale + ")");
  p2.append("g").attr(
    "style",
    "fill:#ffffff; stroke:#000000; stroke-linecap:butt;"
  );
...
const whiteKnight = (svg) => {
  const p4 = svg
    ...
    .attr("transform", "translate(135,0) scale(" + pieaceScale + ")");
  p4.append("path")
...
const whiteRook = (svg) => {
  const p5 = svg
    ...
    .attr("transform", "translate(180,0) scale(" + pieaceScale + ")");
  p5.append("path")
...
const whitePawn = (svg) => {
  const p6 = svg
    .append("g")
    .attr("transform", "translate(225,0) scale(" + pieaceScale + ")");
  p6.append("path")
    .attr(
      "d",
...
const blackKing = (svg) => {
  const p7 = svg
    ...
    .attr("transform", "translate(0,45) scale(" + pieaceScale + ")");
  p7.append("path")
    .attr("d", "M 22.5,11.63 L 22.5,6")
    .attr("style", "fill:none; stroke:#000000; stroke-linejoin:miter;");
  p7.append("path")
...
const blackQueen = (svg) => {
  const p8 = svg
    ...
    .attr("transform", "translate(45,45) scale(" + pieaceScale + ")");
...
const blackBishop = (svg) => {
  const p10 = svg
    ...
    .attr("transform", "translate(90,45) scale(" + pieaceScale + ")");
  const p11 = p10
    .append("g")
    .attr(
      "style",
...
const blackKnight = (svg) => {
  const p12 = svg
    ...
    .attr("transform", "translate(135,45) scale(" + pieaceScale + ")");
  p12
    .append("path")
    .attr("d", "M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18")
    .attr("style", "fill:#000000; stroke:#000000;");
...
const blackRook = (svg) => {
  const p13 = svg
    ...
    .attr("transform", "translate(180,45) scale(" + pieaceScale + ")");
  p13
    .append("path")
    .attr("d", "M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z ")
    .attr("style", "stroke-linecap:butt;");
...
const blackPawn = (svg) => {
  const p14 = svg
    .append("g")
    .attr("transform", "translate(225,45) scale(" + pieaceScale + ")");
  p14
    .append("path")
    .attr(
      "d",
